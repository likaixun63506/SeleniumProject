...
public class CreateSupplyManagementRecord2 {
	  WebDriver driver ;
	@Test
	public void CreateRecord() throws Exception {
		...
		//登录78OA
		//从map中读取
		//driver.findElement(By.xpath(".//*[@id='account']/div/input")).sendKeys(ReadExcelData.getMapData("valid_username"));
		//从for循环中读取
		//driver.findElement(By.xpath(".//*[@id='account']/div/input")).sendKeys(ReadExcelData.getTestData("valid_username"));
		//driver.findElement(utills.getlocator("username_editbox_locator")).sendKeys(utills.getTestData("valid_username"));
		
		//utills.getElement("username_editbox_locator").sendKeys(utills.getTestData("valid_username"));
